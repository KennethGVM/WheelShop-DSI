import { InventoryReportProps } from '@/types/types';
import {
  Document,
  Page,
  Text,
...
export default function InventoryReport({ inventory }: { inventory: InventoryReportProps[] }) {
  const getTotalSales = (data: typeof inventory) =>
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={{ marginTop: 5 }}>INVENTARIO FINAL DEL MES</Text>
        ...
        <View style={styles.table}>
          ...
          <View style={[styles.tableRow, styles.totalRow]}>
            ...
            <Text style={styles.tableCell}>
              {getTotalSales(inventory).toLocaleString()}
            </Text>
          </View>
        </View>
