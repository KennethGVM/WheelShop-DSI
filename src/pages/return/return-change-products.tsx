...
export default function ReturnChangeProducts({
  isModalOpen,
  handleChangeShowModal,
  productsChange,
  setProductsChange,
}: ReturnChangeProductsProps) {
    ...
    <FormSection name="Cambiar artículos">
      <>
        <span className="text-sm text-secondary/80 mb-4 block">
          Artículos que se enviarán al cliente. Los artículos no se reservarán
          hasta que proceses la devolución.
        </span>
        ...
        <div className="border rounded-lg p-1">
          <Button
            onClick={() => {
              handleChangeShowModal('products', true);
            }}
            type="button"
          >
