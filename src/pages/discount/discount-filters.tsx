...
export default function DiscountFilters({ filters, setFilters, isSearching, discounts }: DiscountFiltersProps) {
  const handleDateFilter = (type: string) => {
    ...
    switch (type) {
      ...
      case "this-month":
        ...
        // último día del mes actual: se crea la fecha día 0 del siguiente mes, que es el último día del mes actual
  ...
  return (
    <div
      className={`overflow-hidden ${discounts && discounts.length > 0 ? "border-0" : "border-b border-gray-300"
