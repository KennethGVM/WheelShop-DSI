...
export default function SaleSort({ sales, isSearching, SORTS_SALES, selectedFilters, handleChangeSelectedFilters, setIsSearching, setTextSearch, setSales }: SaleSortProps) {
  const getFieldType = (field: string) => {
    if (["Codigo de la venta", "Tipo de venta", "Cliente", "Observaciones"].includes(field)) {
      return "string";
