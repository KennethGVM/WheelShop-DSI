...
export default function ProductSort({ setTextSearch, products, isSearching, SORTS_PRODUCTS, selectedFilters, handleChangeSelectedFilters, setIsSearching, setProducts }: ProductSortProps) {
  const getFieldType = (field: string) => {
    if (["Titulo del producto", "Tipo de vehiculo", "Marca", "Proveedor","Estado","Numeracion", "Marca de aceite", "¿Es diésel?", "Numeración del aceite"].includes(field)) {
      return "string";
