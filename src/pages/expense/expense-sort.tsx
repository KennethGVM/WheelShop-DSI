...
export default function ExpenseSort({ setTextSearch, expenses, isSearching, SORTS_EXPENSES, selectedFilters, handleChangeSelectedFilters, setIsSearching, setExpenses }: ExpenseSortProps) {
  const getFieldType = (field: string) => {
    if (["Nombre", "Descripcion", "Moneda", "Forma de pago", "Usuario", "Categoria"].includes(field)) {
      return "string";
