...
interface CashBoxArchingSummaryProps {
...
export default function CashBoxArchingSummary({ totalCordobas, totalDollars, totalCordobaCoins, totalCordobaBank, totalDollarBank, totalCordobaTransfer, totalDollarTransfer, generalTotal, cashBoxSummary }: CashBoxArchingSummaryProps) {
  return (
    <>
      <FormSection name='Resumen de arqueo' className='px-0 pb-3' classNameLabel='mx-4'>
        <>
