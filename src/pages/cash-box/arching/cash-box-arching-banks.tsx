...
export default function CashBoxArchingBanks({ isEditing, setBankAmounts, banks, currencies, bankAmounts, selectedCurrency, setSelectedCurrency }: CashBoxArchingBanksProps) {
