...
interface CashBoxArchingTicketsProps {
  isEditing: boolean;
...
export default function CashBoxArchingTickets({ isEditing, quantities, denominations, setQuantities }: CashBoxArchingTicketsProps) {
