...
export default function ArchingSort({ setTextSearch, archings, isSearching, SORTS_ARCHINGS, selectedFilters, handleChangeSelectedFilters, setIsSearching, setArchings }: ArchingSortProps) {
