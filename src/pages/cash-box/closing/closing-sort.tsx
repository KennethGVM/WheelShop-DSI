...
interface ClosingSortProps {
  closings: ClosingProps[];
  isSearching: boolean;
  SORTS_CLOSINGS: string[];
...
export default function ClosingSort({ setTextSearch, closings, isSearching, SORTS_CLOSINGS, selectedFilters, handleChangeSelectedFilters, setIsSearching, setClosings }: ClosingSortProps) {
