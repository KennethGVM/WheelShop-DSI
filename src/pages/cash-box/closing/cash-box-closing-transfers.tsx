...
export default function CashBoxClosingTransfers({ isEditing, bankTransfers, setBankTransfers, banks, currencies, selectedTransfer, setSelectedTransfer }: CashBoxClosingBanksProps) {
