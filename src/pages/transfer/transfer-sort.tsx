...
interface TransferSortProps {
  transfers: TransferProps[];
  isSearching: boolean;
  SORT_TRANSFER: string[];
...
export default function TransferSort({ transfers, isSearching, SORT_TRANSFER, selectedFilters, handleChangeSelectedFilters, setIsSearching, setTextSearch, setTransfers }: TransferSortProps) {
  const getFieldType = (field: string) => {
    if (["Nombre del usuario", "Codigo de transferencia", "Origen", "Destino"].includes(field)) {
      return "string";
