...
interface StoreHouseSortProps {
  storeHouses: StoreHouseProps[];
  inputRef: React.RefObject<HTMLInputElement | null>;
  isSearching: boolean;
  SORTS_STORE_HOUSES: string[];
...
export default function StoreHouseSort({ setStoreHouses, storeHouses, isSearching, SORTS_STORE_HOUSES, selectedFilters, handleChangeSelectedFilters, setIsSearching, inputRef }: StoreHouseSortProps) {
    ...
    <div className="flex items-center space-x-2">
      ...
      <Dropdown closeToClickOption={false}>
        ...
        <DropdownContent align="end">
          {SORTS_STORE_HOUSES.map((sort, index) => (
