...
export default function QuotationFilters({ filters, setFilters, isSearching, quotations }: QuotationFiltersProps) {
  ...
  return (
    <div className={`overflow-hidden ${quotations && quotations.length > 0 ? 'border-0' : 'border-b border-gray-300'} transition-all duration-200 ease-out ${isSearching ? "max-h-20 opacity-100" : "max-h-0 opacity-0"}`}>
