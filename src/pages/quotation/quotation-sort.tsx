...
export default function QuotationSort({ setTextSearch, quotations, isSearching, SORTS_SALES, selectedFilters, handleChangeSelectedFilters, setIsSearching, setQuotations }: QuotationSortProps) {
  const getFieldType = (field: string) => {
    if (["Codigo de la cotizacion", "Estado de la cotización", "Cliente", "Observaciones"].includes(field)) {
      return "string";
    } if (["Creado", "Estado", "descuento", "subtotal", "total"].includes(field)) {
      return "date";
    } else {
      return "number";
    }
