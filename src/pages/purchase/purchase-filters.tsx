...
export default function PurchaseFilters({ filters, setFilters, isSearching, purchases }: PurchaseFiltersProps) {
  ...
  return (
    <div className={`overflow-hidden ${purchases && purchases.length > 0 ? 'border-0' : 'border-b border-gray-300'} transition-all duration-200 ease-out ${isSearching ? "max-h-20 opacity-100" : "max-h-0 opacity-0"}`}>
