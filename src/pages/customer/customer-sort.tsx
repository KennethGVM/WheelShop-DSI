...
export default function CustomerSort({ setTextSearch, customers, isSearching, SORTS_CUSTOMERS, selectedFilters, handleChangeSelectedFilters, setIsSearching, setCustomers }: CustomerSortProps) {
  const getFieldType = (field: string) => {
    if (["Nombre del cliente", "Categoria cliente", "Identificación"].includes(field)) {
      return "string";
    ...
    <div className="flex items-center space-x-2">
      ...
      <Dropdown closeToClickOption={false}>
        ...
        <DropdownContent align="end">
          {SORTS_CUSTOMERS.map((sort, index) => (
